...
/// [CustomWidgetInspector.selectButtonBuilder].
...
/// [CustomWidgetInspectorService.selectionChangedCallback].
...
/// using [CustomWidgetInspectorService].
...
// Production implementation of [CustomWidgetInspectorService].
class _CustomWidgetInspectorService = Object with CustomWidgetInspectorService;

/// Service used by GUI tools to interact with the [CustomWidgetInspector].
///
...
/// form `CustomWidgetInspectorService.instance.methodName(arg1, arg2, ...)`. If you
...
mixin CustomWidgetInspectorService {
  ...
  /// The current [CustomWidgetInspectorService].
  static CustomWidgetInspectorService get instance => _instance;
  static CustomWidgetInspectorService _instance = _CustomWidgetInspectorService();

  @protected
  static set instance(CustomWidgetInspectorService instance) {
    _instance = instance;
  }
  ...
  /// GUI tools such as the Flutter IntelliJ Plugin and the [CustomWidgetInspector]
  /// displayed on the device.
  final InspectorSelection selection = InspectorSelection();

  /// Callback typically registered by the [CustomWidgetInspector] to receive
  ...
  /// Set the [CustomWidgetInspector] selection to the object matching the specified
  ...
  /// Set the [CustomWidgetInspector] selection to the specified `object` if it is
  ...
  /// All events dispatched by a [CustomWidgetInspectorService] use this method
  /// instead of calling [developer.postEvent] directly so that tests for
  /// [CustomWidgetInspectorService] can track which events were dispatched by
...
class _CustomWidgetInspectorState extends State<CustomWidgetInspector>
  ...
  _CustomWidgetInspectorState()
      : selection = CustomWidgetInspectorService.instance.selection;
  ...
  void initState() {
    ...
    CustomWidgetInspectorService.instance.selectionChangedCallback =
        _selectionChangedCallback;
  }

  @override
  void dispose() {
    if (CustomWidgetInspectorService.instance.selectionChangedCallback ==
        _selectionChangedCallback) {
      CustomWidgetInspectorService.instance.selectionChangedCallback = null;
    }
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // assumes the root RenderObject for the CustomWidgetInspector will be
...
Iterable<DiagnosticsNode> _describeRelevantUserCode(Element element) {
  if (!CustomWidgetInspectorService.instance.isWidgetCreationTracked()) {
...
class InspectorSerializationDelegate
  ...
  /// Service used by GUI tools to interact with the [CustomWidgetInspector].
  final CustomWidgetInspectorService service;
  ...
  /// [CustomWidgetInspectorService.disposeGroup()] is called on [groupName].
